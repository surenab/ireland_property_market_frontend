...
function HeatMapPageContent() {
  ...
  useEffect(() => {
    ...
    const newUrl = params.toString() ? `/heatmap?${params.toString()}` : '/heatmap';
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between mb-2">
            <h2 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">HeatMap Analysis</h2>
            <button
